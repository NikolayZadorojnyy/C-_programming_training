...
var inputValue1 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int a = Convert.ToInt32(inputValue1); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue2 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int b = Convert.ToInt32(inputValue2); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue3 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int c = Convert.ToInt32(inputValue3); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue4 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int d = Convert.ToInt32(inputValue4); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue5 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int e = Convert.ToInt32(inputValue5); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue6 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int f = Convert.ToInt32(inputValue6); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue7 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int g = Convert.ToInt32(inputValue7); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue8 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
int i = Convert.ToInt32(inputValue8); // Преобразование строки в число
Console.Write("Введите число > "); // Вывод приглашения ввода
var inputValue9 = Console.ReadLine(); // Ввод строки с терминала (с консоли)
